            ...
            <div className="relative bg-gradient-to-b from-orange-50 to-orange-100 text-slate-800 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
                    <div className="grid md:grid-cols-4 gap-10">
                            ...
                            <address className="not-italic text-sm font-inter space-y-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    >
                                        ...
                                        <p>S NO 24 P VISHAL NAGAR,JAGTAP DAIRY,Sangavi,Pune City,Pune,Maharashtra,India,411027</p>
                                    </a>
                                </div>
                                <div className="flex items-center gap-3">
                                    <a href="tel:+919137476346" className="flex items-center gap-3">
                                        <i className="fas fa-phone-alt text-orange-500"></i>
                                        <p>+91 9137476346</p>
                                    </a>
                                </div>
                                <div className="flex items-center gap-3">
                                    <a href="mailto:chance2sports@gmail.com" className="flex items-center gap-3">
                                        <i className="fas fa-envelope text-orange-500"></i>
                                        <p>chance2sports@gmail.com</p>
                                    </a>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <a href="https://www.linkedin.com/company/rollingnicks/" className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                    <i className="fab fa-linkedin text-white"></i>
                                </a>
                                <a href="https://www.facebook.com/share/1JUTfGg8Zj/" className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                    <i className="fab fa-facebook text-white"></i>
                                </a>
                                <a href="https://www.instagram.com/championsgurukul?igsh=MWdjamwwMDgycjF1YQ==" className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition">
                                    <i className="fab fa-instagram text-white"></i>
                                </a>
                                <a
                                    href="https://wa.me/919137476346"
                                    target="_blank"
                                    rel="noopener noreferrer"
                    ...
                    <div className="border-t border-gray-300 mt-12 pt-6 text-center text-sm font-inter">
                        ...
                        <p className='pt-2'>Build by Inbru Digital</p>
                    </div>
                </div>
            </div>
        </>
